...
public class TextField03_Calc implements ActionListener{
	JTextField tf1, tf2, tf3; // 두칸은 입력칸, 마지막은 출력칸
	JButton b1, b2; // +, - 버튼
	...
	public void actionPerformed(ActionEvent e) {
		...
		String s1 = tf1.getText(); // 텍스트 피드의 입력값
		String s2 = tf2.getText(); // 텍스트 피드의 입력값
		...
		if(e.getSource() == b1) { // e.getSource() : 클릭된 자원이 누구냐?
			System.out.println("덧셈을 선택하였습니다.");
			c = a + b;
			System.out.printf("%d + %d = %d" ,a, b, c );
		}else if(e.getSource() == b2) { // e.getSource() : 클릭된 자원이 누구냐?
			System.out.println("뺄셈을 선택하였습니다.");
			c = a - b;
			System.out.printf("%d - %d = %d" ,a, b, c );
		}
