...
/**
 * [생성자에서 만들기] jFrame, JButton 및 메소드 호출을 생성하는 모든 코드를 Java 생성자 내부에 작성할 수 있습니다.
 */

public class CreateSwing02 {

	// 필드
	JFrame frame; // 윈도우 창(프레임)
	...
	public CreateSwing02() {
		...
		b.setBounds(130, 100, 100, 40); // 버튼에 좌표 설정

		frame.add(b); // 버튼을 프레임에 장착
